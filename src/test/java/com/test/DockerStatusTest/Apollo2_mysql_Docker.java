...
public class Apollo2_mysql_Docker {
    ...
    public void MySql_DB_Status() {
        ...
        try {
            ...
            if (!isRunning) {
                sendEmailAlert("Nathan bro 😩,\n\n🚨 This is Apollo2 MySQL Docker. I am currently down. Kindly restart the container at your earliest convenience.");
    ...
    public void sendEmailAlert(String messageBody) {
        ...
        String subject = "Docker Container Alert - Apollo2 MySQL";
